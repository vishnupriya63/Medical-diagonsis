...
background_image_url = "https://narwalinc.com/wp-content/uploads/2024/10/businessman-using-ai-artificial-intelligence-plann-4-scaled.jpg"  # Replace with your image URL
...
def my_function():
    ...
    st.write("Running in a separate thread!")
